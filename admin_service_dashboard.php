   ...
   include("data_class.php");
    ?>
        ...
        <div class="innerdiv">
            ...
            <div>Branch:<input type="checkbox" name="branch" value="it"/>it<input type="checkbox" name="branch" value="civil"/> Civil<div style="margin-left:80px"><input type="checkbox" name="branch" value="ec"/>ec<input type="checkbox" name="branch" value="electrical"/>electrical</div>
            </div>   
